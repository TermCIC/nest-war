...
/** @type {string} */
const CACHE_VERSION = '1736951914|4924594189';
/** @type {string} */
const CACHE_PREFIX = 'Nest War-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'nest-war.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["nest-war.html","nest-war.js","nest-war.offline.html","nest-war.icon.png","nest-war.apple-touch-icon.png","nest-war.worker.js","nest-war.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["nest-war.wasm","nest-war.pck"];
